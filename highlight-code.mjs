...
hljs.configure({ languages: ['iql', 'javascript'] });

class HighlightCode extends LitElement {
  static styles = css`
    :host {
      margin: 0;
      padding: 0;
  ...
  render() {
    const { value: innerHTML } = hljs.highlight(this.textContent, { language: this.language });
